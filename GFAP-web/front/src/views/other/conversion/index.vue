  ...
  <div class="conversion-container">
    ...
    >
      <a-form-item name="upload" label="">
        ...
        <label>input the transcriptome-annotated result</label>
        <a-upload-dragger
      ...
      <a-form-item name="gene_sequence">
        <a-textarea
          ...
          placeholder="If you want to use the example data, the following parameters should be set as: GO ID:1, GO/KEGG ID:28, pvalue index: 5"
          style="height: 15vh"
        >
        </a-textarea>
      </a-form-item>
      ...
      <a-form-item name="geneid">
        <a-input
          style="width: 100%"
          v-model:value="formState['geneid']"
          placeholder="input the column index"
          addon-before="Gene ID"
        />
      </a-form-item>
      <a-form-item name="goid">
        <a-input
          style="width: 100%"
          v-model:value="formState['goid']"
          placeholder="input the column index"
          addon-before="GO/KEGG ID"
        />
      </a-form-item>
...
<script>
import { example_gene_sequence } from "../../../static/transcriptome_annotated_result.ts";
        ...
        goid: [
          {
            type: "string",
            required: true,
            message: "Please input GO/KEGG ID!",
          },
        ],
        pvalue: [
          {
